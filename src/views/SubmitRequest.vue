<template>
  <div class="min-h-screen bg-[#081640] bg-gradient-to-br from-[#081640] to-[#0c1f54] p-4 md:p-8 flex items-center justify-center relative overflow-hidden">
    <div class="w-full max-w-7xl relative"> <!-- Increased max-width -->
      <h1 class="text-4xl md:text-5xl font-bold text-center mb-8 text-white">
        Submit a Request
      </h1>

      <form @submit.prevent="onSubmit" class="space-y-6"> <!-- Reduced vertical spacing -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6"> <!-- Changed to 3 columns -->
          <!-- Email and Request Type in first row -->
          <div class="md:col-span-2 group bg-white/[0.03] p-6 rounded-2xl border border-white/10 hover:border-[#3587F2]/30 transition-all duration-300">
            <label class="block text-sm font-medium text-white/90 mb-2">
              Email Address <span class="text-[#3587F2]">*</span>
            </label>
            <input 
              type="email" 
          ...
          <div class="md:col-span-1 group bg-white/[0.03] p-6 rounded-2xl border border-white/10 hover:border-[#3587F2]/30 transition-all duration-300">
            <label class="block text-sm font-medium text-white/90 mb-2">
              Request Type <span class="text-[#3587F2]">*</span>
            </label>
            <select 
          ...
          <!-- Business Impact in first row -->
          <!-- Business Impact and Profile Impersonation row -->
          <div class="md:col-span-2 group bg-white/[0.03] p-6 rounded-2xl border border-white/10 hover:border-[#3587F2]/30 transition-all duration-300">
            <label class="block text-sm font-medium text-white/90 mb-2">
              Business Impact
            </label>
          ...
          <div class="md:col-span-3 group bg-white/[0.03] p-6 rounded-2xl border border-white/10 hover:border-[#3587F2]/30 transition-all duration-300">
            <label class="block text-sm font-medium text-white/90 mb-2">
              Subject <span class="text-[#3587F2]">*</span>
            </label>
            <input 
              type="text" 
          ...
          <div class="md:col-span-3 group bg-white/[0.03] p-6 rounded-2xl border border-white/10 hover:border-[#3587F2]/30 transition-all duration-300">
            <label class="block text-sm font-medium text-white/90 mb-2">
              Description <span class="text-[#3587F2]">*</span>
            </label>
            ...
            <textarea 
              ...
              required
              rows="6"
              placeholder="Please provide as much detail as possible to help us understand and resolve your request efficiently.The more information you provide, the better we can assist you."
              class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3.5 text-white placeholder-white/40 focus:ring-2 focus:ring-[#3587F2]/50 focus:border-[#3587F2]/50 transition-all duration-300"
            ></textarea>
          </div>
